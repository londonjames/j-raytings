...
NEWSLETTER_IMAGES = [
    ...
    'https://media.licdn.com/dms/image/v2/C4D12AQE0sgTMyXwx1g/article-cover_image-shrink_720_1280/article-cover_image-shrink_720_1280/0/1624510314269?e=1766016000&v=beta&t=FnGQIk3pPQIeVQd1k7bCgi93TZOCvKYANccYVph2HkU',  # 3: middle-left (swapped from middle-middle) - needs special crop
    'https://media.licdn.com/dms/image/v2/C4D12AQHBut1nEY4gMg/article-cover_image-shrink_423_752/article-cover_image-shrink_423_752/0/1620883418698?e=1766016000&v=beta&t=SG5G79yf2i2keBm3ga1C0I6N7elQNclI3c4ciCeEQLM',  # 4: middle-middle (swapped from middle-left) - orange in middle
...
# Image at position 3 (Andy Grove, now in middle-left) needs to show more of the top (less crop from top)
SPECIAL_CROP_IMAGES = {
    3: {'top_crop_ratio': 0.05}  # Only crop 5% from top, 95% from bottom (to show header)
}
